      ...
      <div className="container">
        <div className="grid gap-10 lg:grid-cols-[1.3fr_0.9fr] lg:gap-14">
          ...
          <div>
            ...
            <div className="mt-6 space-y-4 whitespace-pre-line text-base leading-8 text-navy-700">
              {course.description}
            </div>
          ...
          {/* Supporting Section */}
          <aside className="rounded-2xl border border-primary-100 bg-primary-50/50 p-6 lg:p-8">
            ...
            <div className="mt-6 rounded-lg bg-primary-100/60 p-4">
